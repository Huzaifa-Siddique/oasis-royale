    ...
    <section className="w-full min-h-screen flex flex-col items-center justify-between py-24 bg-black">
      ...
      <div className="relative w-full h-[50vh] flex items-center justify-center z-10">
        ...
        <model-viewer 
          ...
          draco-decoder="/wasm/draco_decoder.wasm"
      ...
      <div className="z-20 mt-10">
        <Link href="/menu" className="px-10 py-4 border border-[#D4AF37]/50 text-[#D4AF37] font-sans font-light tracking-[0.2em] uppercase text-xs sm:text-sm rounded-full backdrop-blur-md bg-white/5 hover:bg-[#D4AF37]/10 hover:border-[#D4AF37] transition-all duration-300 inline-block">
          Explore Menu
        </Link>
      </div>
    </section>
