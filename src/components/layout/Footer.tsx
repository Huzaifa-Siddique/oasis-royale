        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-muted max-w-md leading-relaxed">
              Where the desert meets unparalleled luxury. Experience the finest hospitality beneath the Arabian stars.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted">
              <li>Al Wadi Desert</li>
              <li>Dubai, UAE</li>
              <li>
                <a href="tel:+971500000000" className="hover:text-foreground transition-colors">
                  +971 50 000 0000
                </a>
              </li>
              <li>
                <a href="mailto:reservations@oasisroyale.com" className="hover:text-foreground transition-colors">
