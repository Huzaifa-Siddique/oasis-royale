      ...
      <GlassCard className={`space-y-3 border-2 ${borderUrgency} transition-colors duration-500`}>
        ...
        <div className="space-y-2">
          {order.items.map((item: any) => {
            ...
            return (
              <div key={item.dish_id} className="flex flex-col text-sm border-b border-white/5 pb-1 last:border-0 last:pb-0">
        ...
        {order.special_instructions && (
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-lg p-2.5 text-xs font-mono text-amber-400">
            <span className="text-[9px] uppercase tracking-wider block mb-0.5 font-sans font-semibold">Special Instructions:</span>
            "{order.special_instructions}"
          </div>
        )}
